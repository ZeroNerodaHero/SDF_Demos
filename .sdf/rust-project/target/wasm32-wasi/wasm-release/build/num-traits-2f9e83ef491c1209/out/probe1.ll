...
define internal i8 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$9total_cmp17he2913260a4719937E"(ptr align 8 %self, ptr align 8 %other) unnamed_addr #0 {
start:
...
; call core::f64::<impl f64>::total_cmp
  %_1 = call i8 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$9total_cmp17he2913260a4719937E"(ptr align 8 @alloc_f93507f8ba4b5780b14b2c2584609be0, ptr align 8 @alloc_ef0a1f828f3393ef691f2705e817091c) #2
  ret void
}

attributes #0 = { inlinehint nounwind "target-cpu"="generic" "target-features"="+simd128" }
attributes #1 = { nounwind "target-cpu"="generic" "target-features"="+simd128" }
