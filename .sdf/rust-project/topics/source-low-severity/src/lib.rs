...
mod bindings {
    ...
    generate!(
        { world : "source-low-severity-world", path : ".wit", additional_derives :
...
mod serialize {
    ...
    use crate::bindings::exports::examples::source_low_severity::deserialize::StatusLog;
    use crate::bindings::exports::examples::source_low_severity::deserialize::Guest as DeserializeInputInterface;
