...
mod bindings {
    ...
    generate!(
        { world : "source-status-world", path : ".wit", additional_derives :
...
mod serialize {
    ...
    use crate::bindings::exports::examples::source_status::deserialize::StatusLog;
    use crate::bindings::exports::examples::source_status::deserialize::Guest as DeserializeInputInterface;
