...
use crate::{
    ...
    wit::lazy::{
        ...
        Operator as WitOperator,
    },
};
pub use crate::bindings::sdf::df::lazy::{DfValue, SortOptions};
...
impl LazyDf {
    ...
    pub fn sort(&self, columns: impl Into<ColumnNames>, options: SortOptions) -> Result<Self> {
